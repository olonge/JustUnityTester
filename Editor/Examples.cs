...
using JustUnityTester.Exceptions;
using NUnit.Framework;


/// <summary>
/// Ports over the <b>Examples</b> from <br></br>
/// .../Examples/Test/Editor/Testforscene1TestSample.cs <br></br>
/// ..even though the Scene that they point to is no loger included, <br></br>
/// but they are included to show how to correctly call them.
/// </summary>
[Timeout(5000)]
public class Examples {  // TODO: Replace with own scene and documented tests
    private TestsDriver altUnityDriver;
    [OneTimeSetUp]
    public void SetUp() => altUnityDriver = new TestsDriver();

    [OneTimeTearDown]
    public void TearDown() => altUnityDriver.Stop();

    [SetUp]
    public void LoadLevel() => altUnityDriver.LoadScene("Scene 1 AltUnityDriverTestScene");

    [Test]
    public void TestGetCurrentScene() => Assert.AreEqual("Scene 1 AltUnityDriverTestScene", altUnityDriver.GetCurrentScene());
    ...
    public void TestDifferentCamera() {
        ...
        var pozOnScreenFromMainCamera = new TestVector2(altElement.x, altElement.y);
        var pozOnScreenFromSecondaryCamera = new TestVector2(altElement2.x, altElement2.y);
    ...
    public void TestButtonClickWithSwipe() {
        ...
        var vector2 = new TestVector2(button.x, button.y);
    ...
    public void TestCallMethodWithAssembly() {
        ...
        var capsuleAfterRotation = altUnityDriver.FindObject(By.NAME, "Capsule");
    ...
    public void TestGetAllFields() {
        ...
        var properties = altElement.GetAllProperties(component);
        var field = properties.First(prop => prop.name.Equals("stringToSetFromTests"));
        Assert.NotNull(field);
        Assert.AreEqual(field.value, "intialValue");
    }
    [Test]
    public void TestGetAllComponents() {
        var components = altUnityDriver.FindObject(By.NAME, "Canvas").GetAllComponents();
    ...
    public void TestGetAllMethodsFromClass() {
        ...
        List<String> methods = altElement.GetAllMethods(component2, TestMethodSelection.CLASSMETHODS);
    ...
    public void TestGetAllMethodsFromInherited() {
        var altElement = altUnityDriver.FindObject(By.NAME, "Capsule");
        var component2 = altElement.GetAllComponents().First(component => component.componentName.Equals("AltUnityExampleScriptCapsule"));
        List<String> methods = altElement.GetAllMethods(component2, TestMethodSelection.INHERITEDMETHODS);
    ...
    public void TestGetAllMethods() {
        var altElement = altUnityDriver.FindObject(By.NAME, "Capsule");
        var component2 = altElement.GetAllComponents().First(component => component.componentName.Equals("AltUnityExampleScriptCapsule"));
        List<String> methods = altElement.GetAllMethods(component2, TestMethodSelection.ALLMETHODS);
        Assert.IsTrue(methods.Contains("Void CancelInvoke(System.String)"));
        Assert.IsTrue(methods.Contains("Void UIButtonClicked()"));
    }
    ...
    public void TestInactiveObject() {
        var cube = altUnityDriver.FindObject(By.NAME, "Cube", enabled: false);
    ...
    public void TestTapScreenWhereThereIsNoObjects() {
        var altObject = altUnityDriver.TapScreen(1, 1);
    ...
    public void TestGet3DObjectFromScreenshot() {
        var capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
        altUnityDriver.GetScreenshot(new TestVector2(capsule.x, capsule.y),
            new TestColor(1, 0, 0, 1), 1, out TestObject altUnityObject, new TestVector2(1920, 1080));
    ...
    public void TestGetUIObjectFromScreenshot() {
        var capsuleInfo = altUnityDriver.FindObject(By.NAME, "CapsuleInfo");
        altUnityDriver.GetScreenshot(new TestVector2(capsuleInfo.x, capsuleInfo.y),
            new TestColor(1, 0, 0, 1), 1, out TestObject altUnityObject, new TestVector2(1920, 1080));
    ...
    public void TestObjectFromScreenshot() {
        ...
        var offscreenCoordinates = new TestVector2(icon.x + 400, icon.y);
        altUnityDriver.GetScreenshot(offscreenCoordinates, new TestColor(1, 0, 0, 1), 1,
            out TestObject altUnityObject, new TestVector2(1920, 1080));
    ...
    public void TestAcceleration() {
        ...
        altUnityDriver.Tilt(new TestVector3(1, 1, 1), 1);
        Thread.Sleep(1000);
    ...
    public void TestAccelerationAndWait() {
        var capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
        var initialWorldCoordinates = capsule.getWorldPosition();
        altUnityDriver.TiltAndWait(new TestVector3(1, 1, 1), 1);
        Thread.Sleep(1000);
        capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
        var afterTiltCoordinates = capsule.getWorldPosition();
        Assert.AreNotEqual(initialWorldCoordinates, afterTiltCoordinates);
